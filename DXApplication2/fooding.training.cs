...
namespace DXApplication2
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\iyadb\OneDrive\Desktop\data\te.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"vacance", @"vacance"),new InputOutputColumnPair(@"n", @"n")})      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"month",outputColumnName:@"month"))      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"nom",outputColumnName:@"nom"))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"vacance",@"n",@"month",@"nom"}))      
                                    .Append(mlContext.Regression.Trainers.LbfgsPoissonRegression(new LbfgsPoissonRegressionTrainer.Options(){L1Regularization=1.952598F,L2Regularization=0.52863044F,LabelColumnName=@"qt",FeatureColumnName=@"Features"}));

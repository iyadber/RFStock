...
namespace DXApplication2.UserControls
{
	public partial class MyTextBox : UserControl
	{
		...
		public static readonly DependencyProperty ValueProperty = DependencyProperty.Register("Value", typeof(string), typeof(MyTextBox));
		...
		private void textBox_TextChanged(object sender, TextChangedEventArgs e)
		{
			...
			{
				textBox.Style = (Style)Application.Current.Resources["TextError"];
			}
			else
			{
				textBox.Style = (Style)Application.Current.Resources["TextNormal"];
			}
		}
	}
